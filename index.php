...
<html lang="en">
<head>
   <title>Mrittika Bank - mrittika megaraj </title>
   <meta charset="utf-8">
...
<nav class="navbar navbar-expand-lg navbar-blue bg-white">
  <div class="container-fluid">
    <a class="navbar-brand" href="#">Mrittika Bank   </a>
...
<div  class="col-lg-6 col-md-6 col-12">
      ...
      <div  class="col-lg-6 col-md-6 col-12">
      <h1>Mrittika Bank</h1>
      <p1> Mrittika Bank is a part of Mrittika foundation. It is one of Znations's leading private banks and was among the first to receive approval from the Central bank of Znation (CBZ) to set up a private sector bank in 992 ZY.
          Today, Mrittika Bank has a banking network of 5,608 branches and 16,087 ATM's in 2,902 cities/towns. Mrittika Bank offers a diverse range of financial products and banking services to customers through a growing branch and ATM network and digital channels such as Netbanking, Phonebanking and MobileBanking.
...
<footer class="text-center mt-2 py-5">
        <p>&copy 2021  <b>Mrittika</b> </br>Chairman, Mrittika Foundation</p>
      </footer>
